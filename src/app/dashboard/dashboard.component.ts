...
// Skontrolujeme, či všetky polia majú rovnakú dĺžku
if (this.data.hourly.time.length === this.data.hourly.temperature2m.length &&
  ...
  // Iterujeme cez dĺžku pola time, pretože predpokladáme, že všetky polia majú rovnakú dĺžku
...
//   {position: 44, name: 'sss', weight: 44, symbol:'ss'}
// ];
